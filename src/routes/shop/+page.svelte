<div class="bg-gray-50">
    ...
    -->
        ...
        Leaving: "transition-opacity ease-linear duration-300"
          ...
          To: "opacity-0"
      -->
			<div class="fixed inset-0 bg-black bg-opacity-25 hidden" aria-hidden="true"></div>
		...
		<main>
			<div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
				<div class="py-24 text-center">
					...
					<p class="mx-auto mt-4 max-w-md text-pretty text-base text-gray-500">
						Retrouvez toutes nos bières ici ainsi que l'occasion de créer votre propre pack.
					</p>
				</div>
              ...
              -->
							<div
								class="hidden left-0 z-10 mt-2 w-40 origin-top-left rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none"
								role="menu"
                ...
                -->
								<div
									class="hidden right-0 z-10 mt-2 origin-top-right rounded-md bg-white p-4 shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none"
								>
